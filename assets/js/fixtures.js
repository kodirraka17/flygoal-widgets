! function(e) {
    ...
    function r(e) {
        var t = "",
            n = !0;
        void 0 !== e.showLinks && (e.showLinks || (t = "&showLinks=false", n = !1)), void 0 !== e.tz && (e.tz || (e.tz = "Asia/Jakarta"));
        var r = "&tz=" + e.tz,
            o = "https://widget.flygoal.com/e/fixtures?id=" + e.teamID + t + r,
            u = document.createElement("div");
        u.innerHTML = s.a, document.getElementById("flygoalsp-fixtures").insertAdjacentElement("afterbegin", u);
        var c = document.getElementById("flygoalsp-results-here"),
            f = document.getElementById("flygoalsp-fixtures-here"),
            l = document.getElementById("fgf-replaceBadge"),
            a = document.getElementById("fgf-replaceTitle"),
            p = document.getElementById("flygoalsp-show-fixtures"),
            d = document.getElementById("flygoalsp-show-results");
        fetch(o, {
            method: "GET",
            mode: "cors"
        }).then(function(e) {
            ...
            if (e.image && l.setAttribute("src", imgurl + e.image), e.name ? a.innerHTML = e.name : a.innerHTML = "Not Found", imgurl + e.flag_url && n) {
                var t = document.createElement("img");
                t.classList.add("flygoalsp-country-flag"), t.setAttribute("src", e.flag_url), a.insertAdjacentElement("afterbegin", t)
            }
            if (e.url && n) {
                var r = "https://flygoal.com" + e.url;
            } else y.remove();
            if (e.fixtures) {
                var i = e.fixtures;
            ...
            i("flygoalsp-results-here", this)
        }), p.addEventListener("click", function() {
            i("flygoalsp-fixtures-here", this)
        })
    }

    function i(e, t) {
        var n = document.querySelectorAll(".flygoalsp-fixture-list"),
            r = document.querySelectorAll(".flygoalsp-list-toggle");
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper fixtures">' + 
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="fgf-replaceBadge" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title" id=\'fgf-replaceTitle\'></div>' + 
                '<div class="flygoalsp-medium-title">Matches Fixtures</div>' +
            '</div>' + 
            '<div class="fs-fixture-header">'
                '<p style="font-weight: bold; font-size: 10px; font-family: "Roboto", sans-serif; color: white;">' + 
                    'Powered By <a href="https://flygoal.com" target="_blank" class="flygoalsp-view-all-fixtures">Flygoal.com</a>' + 
                '</p>' +
            '</div>' + 
            '<div class="flygoalsp-embed-body">' + 
                '<div class="flygoalsp-list-toggles">' + 
                    '<a id=\'flygoalsp-show-results\' class=\'flygoalsp-list-toggle active\'>Previous</a>' + 
                    '<a id=\'flygoalsp-show-fixtures\' class="flygoalsp-list-toggle">Upcoming</a>' + 
                '</div>' + 
                '<ul class=\'flygoalsp-fixture-list\' id="flygoalsp-fixtures-here"></ul>' + 
                '<ul class=\'flygoalsp-fixture-list\' id="flygoalsp-results-here"></ul>' +
            '</div>' +
        '</div>' + 
    '</div>'
}, function(e, t, n) {
