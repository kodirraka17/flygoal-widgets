! function(e) {
    ...
    function r(e) {
        ...
        var u = document.getElementById("flygoalsp-InsertRowsHere-laliga"),
            f = document.getElementById("flygoalsp-replaceBadge-laliga"),
            p = document.getElementById("flygoalsp-replaceTitle-laliga");
        l.table = document.getElementById("flygoalsp-EmbedTable-laliga"), 
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper">' +
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="flygoalsp-replaceBadge-laliga" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LEAGUE STANDINGS TABLE</div>' + 
                '<a class="flygoalsp-medium-title" id=\'flygoalsp-replaceTitle-laliga\'></a>' +
            '</div>' +
        '</div>' +
        '<div class="flygoalsp-embed-body">' + 
            '<table class="flygoalsp-embed-table" id="flygoalsp-EmbedTable-laliga">' + 
                '<thead>' + 
                    ...
                    '</tr>' +
                '</thead>' +
                '<tbody id=\'flygoalsp-InsertRowsHere-laliga\'></tbody>' +
            '</table>' +
            '</div>' +
        '</div>' +
    '</div>'
