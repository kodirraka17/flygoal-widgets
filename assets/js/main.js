! function(e) {
    ...
    ! function(e) {
        var t = {
            ...
            n = e[e.flygoalsp_StandingsEmbed],
            o = n.q;
        if (o)
    ...
    function r(e) {
        ...
        var r = "https://widget.flygoal.com/e/Standings?id=1639",
            s = document.createElement("div");
        s.innerHTML = c.a, document.getElementById('flygoalsp-standings').insertAdjacentElement("afterbegin", s);
        var u = document.getElementById("fgInsertRowsHere"),
            f = document.getElementById("replaceBadge"),
            p = document.getElementById("replaceTitle");
        l.table = document.getElementById("fgEmbedTable"), 
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper">' +
        '<div class="flygoalsp-embed-header">' + 
            ...
            '<div class="flygoalsp-header-title">' + 
                ...
                '<a class="flygoalsp-medium-title" id=\'replaceTitle\'></a>' +
            '</div>' +
        '</div>' +
        '<div class="flygoalsp-embed-body">' + 
            '<table class="flygoalsp-embed-table" id="fgEmbedTable">' + 
                '<thead>' + 
                    ...
                    '</tr>' +
                '</thead>' +
                '<tbody id=\'fgInsertRowsHere\'></tbody>' +
            '</table>' +
            '</div>' +
        '</div>' +
    '</div>'
