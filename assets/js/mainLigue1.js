! function(e) {
    ...
    ! function(e) {
        var t = {
            ...
            n = e[e.flygoalsp_StandingsEmbedLigue1],
            o = n.q;
        if (o)
    ...
    function r(e) {
        ...
        var r = "https://widget.flygoal.com/e/Standings?id=1112",
            s = document.createElement("div");
        s.innerHTML = c.a, document.getElementById('flygoalsp-standings-ligue1').insertAdjacentElement("afterbegin", s);
        var u = document.getElementById("fgInsertRowsHere-ligue1"),
            f = document.getElementById("replaceBadge-ligue1"),
            p = document.getElementById("replaceTitle-ligue1");
        l.table = document.getElementById("fgEmbedTable-ligue1"), 
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper">' +
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="replaceBadge-ligue1" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LEAGUE STANDINGS TABLE</div>' + 
                '<a class="flygoalsp-medium-title" id=\'replaceTitle-ligue1\'></a>' +
            '</div>' +
        '</div>' +
        '<div class="flygoalsp-embed-body">' + 
            '<table class="flygoalsp-embed-table" id="fgEmbedTable-ligue1">' + 
                '<thead>' + 
                    ...
                    '</tr>' +
                '</thead>' +
                '<tbody id=\'fgInsertRowsHere-ligue1\'></tbody>' +
            '</table>' +
            '</div>' +
        '</div>' +
    '</div>'
