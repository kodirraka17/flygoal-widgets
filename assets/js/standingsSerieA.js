! function(e) {
    ...
    function r(e) {
        ...
        var u = document.getElementById("flygoalsp-InsertRowsHere-seriea"),
            f = document.getElementById("flygoalsp-replaceBadge-seriea"),
            p = document.getElementById("flygoalsp-replaceTitle-seriea");
        l.table = document.getElementById("flygoalsp-EmbedTable-seriea"), 
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper">' +
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="flygoalsp-replaceBadge-seriea" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LEAGUE STANDINGS TABLE</div>' + 
                '<a class="flygoalsp-medium-title" id=\'flygoalsp-replaceTitle-seriea\'></a>' +
            '</div>' +
        '</div>' +
        '<div class="flygoalsp-embed-body">' + 
            '<table class="flygoalsp-embed-table" id="flygoalsp-EmbedTable-seriea">' + 
                '<thead>' + 
                    ...
                    '</tr>' +
                '</thead>' +
                '<tbody id=\'flygoalsp-InsertRowsHere-seriea\'></tbody>' +
            '</table>' +
            '</div>' +
        '</div>' +
    '</div>'
