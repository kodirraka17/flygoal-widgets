! function(e) {
    ...
    function r(e) {
        ...
        var r = "&tz=" + e.tz,
            o = "https://widget.flygoal.com/e/Upcoming?id=" + e.teamID + t,
            c = document.createElement("div");
        c.innerHTML = i.a, document.getElementById("flygoalnf-upcoming").insertAdjacentElement("afterbegin", c), fetch(o, {
            method: "GET",
            mode: "cors"
        }).then(function(e) {
            return e.json()
            ...
            if (e.date && (document.getElementById("flygoalnf_UpcomingDate").innerHTML = e.date), e.time && (document.getElementById("flygoalnf_UpcomingTime").innerHTML = e.time), e.competition && (document.getElementById("flygoalnf-upcoming-league").innerHTML = e.competition), n) {
                if (e.url) {
                    var t = "https://flygoal.com" + e.url;
                    document.getElementById("flygoalnf-upcoming-match-name").innerHTML = e.match_name, document.getElementById("flygoalnf-upcoming-match-name").setAttribute("href", t)
                }
            } else document.getElementById("showLinks").innerHTML = "<div id='flygoalnf-upcoming-league'>".concat(e.competition, "</div><div class='match-url'>").concat(e.match_name, "</div>");
            document.getElementById("flygoalnf_HomeImage").setAttribute("src", ImageURL + e.home_image), document.getElementById("flygoalnf_AwayImage").setAttribute("src", ImageURL + e.away_image)
        })
    }
    t.a = r;
    var o = n(3),
    ...
    e.exports = '<div class="flygoalnf-upcoming-wrapper">' + 
        '<div class="flygoalnf-upcoming-header">' + 
            '<div class="flygoalnf-upcoming-details">' + 
                '<h2>Next Fixtures</h2>' + 
                '<ul>' + 
                    '<li>' +
                        '<img src="' + ImageURL + '/wp-content/plugins/flygoal-widgets/assets/img/calendar.jpg" id=\'\' alt="" class="flygoalnf-embed-icon">' +
                        '<span id=\'flygoalnf_UpcomingDate\'>Retrieving Data...</span>' +
                    '</li>' + 
                    '<li>' + 
                        '<img src="' + ImageURL + '/wp-content/plugins/flygoal-widgets/assets/img/clock.jpg" alt="" class="flygoalnf-embed-icon">' + 
                        '<span id="flygoalnf_UpcomingTime">Retrieving Data...</span>' + 
                    '</li>' + 
                '</ul>' + 
            '</div>' + 
            '<div class="flygoalnf-upcoming-badges">' +
                '<div class=\'flygoalnf-badge first\'>' + 
                    '<img id="flygoalnf_HomeImage">' + 
                '</div>' + 
                '<div class=\'flygoalnf-badge\'>' + 
                    '<img id=\'flygoalnf_AwayImage\'>' + 
                '</div>' +
            '</div>' +
        '</div>' + 
        '<div class="flygoalnf-upcoming-link" id=\'showLinks\'>' + 
            '<div id="flygoalnf-upcoming-league">Retrieving Data...</div>' + 
                '<a target="_blank" id="flygoalnf-upcoming-match-name">Retrieving Data...</a>' + 
            '</div>' + 
        '</div>'
}, function(e, t, n) {
    (function(e) {
