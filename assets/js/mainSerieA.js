! function(e) {
    ...
    ! function(e) {
        var t = {
            ...
            n = e[e.flygoalsp_StandingsEmbedSerieA],
            o = n.q;
        if (o)
    ...
    function r(e) {
        ...
        var r = "https://widget.flygoal.com/e/Standings?id=1437",
            s = document.createElement("div");
        s.innerHTML = c.a, document.getElementById('flygoalsp-standings-seriea').insertAdjacentElement("afterbegin", s);
        var u = document.getElementById("fgInsertRowsHere-seriea"),
            f = document.getElementById("replaceBadge-seriea"),
            p = document.getElementById("replaceTitle-seriea");
        l.table = document.getElementById("fgEmbedTable-seriea"), 
        ...
        fetch(r, {
            ...
            if (e.image && f.setAttribute("src", imgurl + e.image), e.league_url && (p.setAttribute("href", e.league_url), p.setAttribute("target", "_blank"), p.setAttribute("rel", "nofollow")), e.title ? p.innerHTML = e.title : p.innerHTML = "Not Found", e.flag_url) {
                var t = document.createElement("img");
                t.classList.add("flygoalsp-country-flag"), t.setAttribute("src", imgurl + e.flag_url), p.insertAdjacentElement("afterbegin", t)
            }
            for (var r in e)
                if (void 0 !== e[r].html) {
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper">' +
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="replaceBadge-seriea" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LEAGUE STANDINGS TABLE</div>' + 
                '<a class="flygoalsp-medium-title" id=\'replaceTitle-seriea\'></a>' +
            '</div>' +
        '</div>' +
        '<div class="flygoalsp-embed-body">' + 
            '<table class="flygoalsp-embed-table" id="fgEmbedTable-seriea">' + 
                '<thead>' + 
                    ...
                    '</tr>' +
                '</thead>' +
                '<tbody id=\'fgInsertRowsHere-seriea\'></tbody>' +
            '</table>' +
            '</div>' +
        '</div>' +
    '</div>'
