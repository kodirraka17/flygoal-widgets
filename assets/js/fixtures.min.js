! function(e) {
    ...
    function r(e) {
        ...
        var r = "&tz=" + e.tz,
            o = "https://widget.flygoal.com/e/Result?id=" + e.teamID + t + r,
        ...
        var c = document.getElementById("flygoalsp-results-here"),
            ...
            l = document.getElementById("fgspf-replaceBadge"),
            a = document.getElementById("fgspf-replaceTitle"),
        ...
        fetch(o, {
            ...
            if (e.image && l.setAttribute("src", imgurl + e.image), e.name ? a.innerHTML = e.name : a.innerHTML = "Not Found", e.flag_url && n) {
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper fixtures">' +
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="fgspf-replaceBadge" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">Previous and Results Match</div>' + 
                '<div class="flygoalsp-medium-title" id=\'fgspf-replaceTitle\'></div>' +
            '</div>' + 
            '</div>' +
