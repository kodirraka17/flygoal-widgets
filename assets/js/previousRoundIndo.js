! function(e) {
    ...
    ! function(e) {
        var t = {
            ...
            n = e[e.flygoalsp_PreviousRoundIndo],
            i = n.q;
        if (i)
    ...
    function r(e) {
        ...
        var r = "https://widget.flygoal.com/e/prevRound?id=122116",
            o = document.createElement("div");
        o.innerHTML = i.a, document.getElementById("flygoalsp-previous-round-indo").insertAdjacentElement("afterbegin", o);
        var u = document.getElementById("flygoalsp-previous-round-here-indo"),
            c = document.getElementById("fgsppr-replaceBadge-indo"),
            s = document.getElementById("fgsppr-replaceTitle-indo");
        fetch(r, {
            method: "GET",
            mode: "cors"
        }).then(function(e) {
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper fixtures">' + 
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="fgsppr-replaceBadge-indo" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-string-title">LAST RESULT</div>' + 
                '<div class="flygoalsp-medium-title" id=\'fgsppr-replaceTitle-indo\'></div>' + 
            '</div>' + 
            '</div>' +
            '<div class="flygoalsp-embed-body">' + 
                '<ul class="flygoalsp-next-round-list" id="flygoalsp-previous-round-here-indo"></ul>' + 
            '</div>' + 
        '</div>' + 
    '</div>'
}, function(e, t, n) {
