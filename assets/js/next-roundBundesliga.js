! function(t) {
    ...
    ! function(t) {
        var e = {
            ...
            r = t[t.flygoalnr_UpcomingRoundBundesliga],
            o = r.q;
        if (o)
    ...
    function n(t) {
        ...
        a.innerHTML = o.a, document.getElementById("flygoalnr-upcoming-round-bundesliga").insertAdjacentElement("afterbegin", a);
        var s = document.getElementById("flygoalnr-next-round-here-bundesliga"),
            f = document.getElementById("flygoalnr-replaceBadge-bundesliga"),
            p = document.getElementById("flygoalnr-replaceTitle-bundesliga");
        fetch(i, {
            method: "GET",
            mode: "cors"
        }).then(function(t) {
    ...
    t.exports = '<div class="flygoalnr-embed-wrapper fixtures">' + 
        '<div class="flygoalnr-embed-header">' + 
            '<div class="flygoalnr-header-badge">' + 
                '<img id="flygoalnr-replaceBadge-bundesliga" alt="">' + 
            '</div>' + 
            '<div class="flygoalnr-header-title">' + 
                '<div class="flygoalnr-strong-title">NEXT SCHEDULE</div>' + 
                '<div class="flygoalnr-medium-title" id=\'flygoalnr-replaceTitle-bundesliga\'></div>' + 
            '</div>' +
            '</div>' +
            '<div class="flygoalnr-embed-body">' + 
                '<ul class="flygoalnr-next-round-list" id="flygoalnr-next-round-here-bundesliga"></ul>' + 
            '</div>' +
        '</div>' + 
    '</div>'
}, function(t, e, r) {
