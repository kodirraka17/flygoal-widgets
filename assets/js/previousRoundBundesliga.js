! function(e) {
    ...
    ! function(e) {
        var t = {
            ...
            n = e[e.flygoalsp_PreviousRoundBundesliga],
            i = n.q;
        if (i)
    ...
    function r(e) {
        ...
        var r = "https://widget.flygoal.com/e/prevRound?id=188",
            o = document.createElement("div");
        o.innerHTML = i.a, document.getElementById("flygoalsp-previous-round-bundesliga").insertAdjacentElement("afterbegin", o);
        var u = document.getElementById("flygoalsp-previous-round-here-bundesliga"),
            c = document.getElementById("fgsppr-replaceBadge-bundesliga"),
            s = document.getElementById("fgsppr-replaceTitle-bundesliga");
        fetch(r, {
            method: "GET",
            mode: "cors"
        }).then(function(e) {
            ...
            if (e.logo && c.setAttribute("src", imgurl + e.logo), e.name ? s.innerHTML = e.name : s.innerHTML = "Not Found", e.url && n) {
                var t = e.url;
            }
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper fixtures">' + 
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="fgsppr-replaceBadge-bundesliga" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LAST RESULT</div>' + 
                '<div class="flygoalsp-medium-title" id=\'fgsppr-replaceTitle-bundesliga\'></div>' + 
            '</div>' + 
            '</div>' +
            '<div class="flygoalsp-embed-body">' + 
                '<ul class="flygoalsp-next-round-list" id="flygoalsp-previous-round-here-bundesliga"></ul>' + 
            '</div>' + 
        '</div>' + 
    '</div>'
}, function(e, t, n) {
