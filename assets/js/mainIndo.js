! function(e) {
    ...
    ! function(e) {
        var t = {
            ...
            n = e[e.flygoalsp_StandingsEmbedIndo],
            o = n.q;
        if (o)
    ...
    function r(e) {
        ...
        var r = "https://widget.flygoal.com/e/Standings?id=122116",
            s = document.createElement("div");
        s.innerHTML = c.a, document.getElementById('flygoalsp-standings-indo').insertAdjacentElement("afterbegin", s);
        var u = document.getElementById("fgInsertRowsHere-indo"),
            f = document.getElementById("replaceBadge-indo"),
            p = document.getElementById("replaceTitle-indo");
        l.table = document.getElementById("fgEmbedTable-indo"), 
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper">' +
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="replaceBadge-indo" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LEAGUE STANDINGS TABLE</div>' + 
                '<a class="flygoalsp-medium-title" id=\'replaceTitle-indo\'></a>' +
            '</div>' +
        '</div>' +
        '<div class="flygoalsp-embed-body">' + 
            '<table class="flygoalsp-embed-table" id="fgEmbedTable-indo">' + 
                '<thead>' + 
                    ...
                    '</tr>' +
                '</thead>' +
                '<tbody id=\'fgInsertRowsHere-indo\'></tbody>' +
            '</table>' +
            '</div>' +
        '</div>' +
    '</div>'
