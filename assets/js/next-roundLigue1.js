! function(t) {
    ...
    ! function(t) {
        var e = {
            ...
            r = t[t.flygoalnr_UpcomingRoundLigue1],
            o = r.q;
        if (o)
    ...
    function n(t) {
        ...
        a.innerHTML = o.a, document.getElementById("flygoalnr-upcoming-round-ligue1").insertAdjacentElement("afterbegin", a);
        var s = document.getElementById("flygoalnr-next-round-here-ligue1"),
            f = document.getElementById("flygoalnr-replaceBadge-ligue1"),
            p = document.getElementById("flygoalnr-replaceTitle-ligue1");
        fetch(i, {
            method: "GET",
            mode: "cors"
        }).then(function(t) {
    ...
    t.exports = '<div class="flygoalnr-embed-wrapper fixtures">' + 
        '<div class="flygoalnr-embed-header">' + 
            '<div class="flygoalnr-header-badge">' + 
                '<img id="flygoalnr-replaceBadge-ligue1" alt="">' + 
            '</div>' + 
            '<div class="flygoalnr-header-title">' + 
                '<div class="flygoalnr-strong-title">NEXT SCHEDULE</div>' + 
                '<div class="flygoalnr-medium-title" id=\'flygoalnr-replaceTitle-ligue1\'></div>' + 
            '</div>' +
            '</div>' +
            '<div class="flygoalnr-embed-body">' + 
                '<ul class="flygoalnr-next-round-list" id="flygoalnr-next-round-here-ligue1"></ul>' + 
            '</div>' +
        '</div>' + 
    '</div>'
}, function(t, e, r) {
