! function(e) {
    ...
    function r(e) {
        ...
        var r = "https://widget.flygoal.com/e/prevRound?id=1639",
            o = document.createElement("div");
        o.innerHTML = i.a, document.getElementById("flygoalsp-previous-round").insertAdjacentElement("afterbegin", o);
        var u = document.getElementById("flygoalsp-previous-round-here"),
            c = document.getElementById("fgsppr-replaceBadge"),
            s = document.getElementById("fgsppr-replaceTitle");
        fetch(r, {
            method: "GET",
            mode: "cors"
        }).then(function(e) {
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper fixtures">' + 
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="fgsppr-replaceBadge" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LAST RESULT</div>' + 
                '<div class="flygoalsp-medium-title" id=\'fgsppr-replaceTitle\'></div>' + 
            '</div>' + 
            '</div>' +
            '<div class="flygoalsp-embed-body">' + 
                '<ul class="flygoalsp-next-round-list" id="flygoalsp-previous-round-here"></ul>' + 
            '</div>' + 
        '</div>' + 
    '</div>'
}, function(e, t, n) {
