! function(t) {
    ...
    function n(t) {
        ...
        a.innerHTML = o.a, document.getElementById("flygoalnr-upcoming-round").insertAdjacentElement("afterbegin", a);
        var s = document.getElementById("flygoalnr-next-round-here"),
            f = document.getElementById("flygoalnr-replaceBadge"),
            p = document.getElementById("flygoalnr-replaceTitle");
        fetch(i, {
            method: "GET",
            mode: "cors"
        }).then(function(t) {
    ...
    t.exports = '<div class="flygoalnr-embed-wrapper fixtures">' + 
        '<div class="flygoalnr-embed-header">' + 
            '<div class="flygoalnr-header-badge">' + 
                '<img id="flygoalnr-replaceBadge" alt="">' + 
            '</div>' + 
            '<div class="flygoalnr-header-title">' + 
                '<div class="flygoalnr-strong-title">NEXT SCHEDULE</div>' + 
                '<div class="flygoalnr-medium-title" id=\'flygoalnr-replaceTitle\'></div>' + 
            '</div>' +
            '</div>' +
            '<div class="flygoalnr-embed-body">' + 
                '<ul class="flygoalnr-next-round-list" id="flygoalnr-next-round-here"></ul>' + 
            '</div>' +
        '</div>' + 
    '</div>'
}, function(t, e, r) {
