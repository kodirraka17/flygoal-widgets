! function(e) {
    ...
    ! function(e) {
        var t = {
            ...
            n = e[e.flygoalsp_PreviousRoundLaliga],
            i = n.q;
        if (i)
    ...
    function r(e) {
        ...
        o.innerHTML = i.a, document.getElementById("flygoalsp-previous-round-laliga").insertAdjacentElement("afterbegin", o);
        var u = document.getElementById("flygoalsp-previous-round-here-laliga"),
            c = document.getElementById("fgsppr-replaceBadge-laliga"),
            s = document.getElementById("fgsppr-replaceTitle-laliga");
        fetch(r, {
            method: "GET",
            mode: "cors"
        }).then(function(e) {
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper fixtures">' + 
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="fgsppr-replaceBadge-laliga" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LAST RESULT</div>' + 
                '<div class="flygoalsp-medium-title" id=\'fgsppr-replaceTitle-laliga\'></div>' + 
            '</div>' + 
            '</div>' +
            '<div class="flygoalsp-embed-body">' + 
                '<ul class="flygoalsp-next-round-list" id="flygoalsp-previous-round-here-laliga"></ul>' + 
            '</div>' + 
        '</div>' + 
    '</div>'
}, function(e, t, n) {
