! function(e) {
    ...
    ! function(e) {
        var t = {
            ...
            n = e[e.flygoalpr_PreviousRoundIndo],
            i = n.q;
        if (i)
    ...
    function r(e) {
        ...
        o.innerHTML = i.a, document.getElementById("flygoalpr-previous-round-indo").insertAdjacentElement("afterbegin", o);
        var u = document.getElementById("flygoalpr-previous-round-here-indo"),
            c = document.getElementById("flygoalpr-replaceBadge-indo"),
            s = document.getElementById("flygoalpr-replaceTitle-indo");
        fetch(r, {
            method: "GET",
            mode: "cors"
        }).then(function(e) {
    ...
    e.exports = '<div class="flygoalpr-embed-wrapper fixtures">' + 
        '<div class="flygoalpr-embed-header">' + 
            '<div class="flygoalpr-header-badge">' + 
                '<img id="flygoalpr-replaceBadge-indo" alt="">' + 
            '</div>' + 
            '<div class="flygoalpr-header-title">' + 
                '<div class="flygoalpr-string-title">LAST RESULT</div>' + 
                '<div class="flygoalpr-medium-title" id=\'flygoalpr-replaceTitle-indo\'></div>' + 
            '</div>' + 
            '</div>' +
            '<div class="flygoalpr-embed-body">' + 
                '<ul class="flygoalpr-next-round-list" id="flygoalpr-previous-round-here-indo"></ul>' + 
            '</div>' + 
        '</div>' + 
    '</div>'
}, function(e, t, n) {
