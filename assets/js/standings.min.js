! function(e) {
    ...
    function r(e) {
        ...
        var u = document.getElementById("flygoalsp-InsertRowsHere"),
            f = document.getElementById("flygoalsp-replaceBadge"),
            p = document.getElementById("flygoalsp-replaceTitle");
        l.table = document.getElementById("flygoalsp-EmbedTable"), 
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper">' +
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="flygoalsp-replaceBadge" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LEAGUE STANDINGS TABLE</div>' + 
                '<a class="flygoalsp-medium-title" id=\'flygoalsp-replaceTitle\'></a>' +
            '</div>' +
        '</div>' +
        '<div class="flygoalsp-embed-body">' + 
            '<table class="flygoalsp-embed-table" id="flygoalsp-EmbedTable">' + 
                '<thead>' + 
                    ...
                    '</tr>' +
                '</thead>' +
                '<tbody id=\'flygoalsp-InsertRowsHere\'></tbody>' +
            '</table>' +
            '</div>' +
        '</div>' +
    '</div>'
