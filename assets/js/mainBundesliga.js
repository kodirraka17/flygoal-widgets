! function(e) {
    ...
    function r(e) {
        ...
        var u = document.getElementById("fgInsertRowsHere-bundesliga"),
            f = document.getElementById("replaceBadge-bundesliga"),
            p = document.getElementById("replaceTitle-bundesliga");
        l.table = document.getElementById("fgEmbedTable-bundesliga"), 
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper">' +
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="replaceBadge-bundesliga" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LEAGUE STANDINGS TABLE</div>' + 
                '<a class="flygoalsp-medium-title" id=\'replaceTitle-bundesliga\'></a>' +
            '</div>' +
        '</div>' +
        '<div class="flygoalsp-embed-body">' + 
            '<table class="flygoalsp-embed-table" id="fgEmbedTable-bundesliga">' + 
                '<thead>' + 
                    ...
                    '</tr>' +
                '</thead>' +
                '<tbody id=\'fgInsertRowsHere-bundesliga\'></tbody>' +
            '</table>' +
            '</div>' +
        '</div>' +
    '</div>'
