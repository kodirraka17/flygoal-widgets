! function(e) {
    ...
    function r(e) {
        ...
        var u = document.getElementById("flygoalsp-InsertRowsHere-indo"),
            f = document.getElementById("flygoalsp-replaceBadge-indo"),
            p = document.getElementById("flygoalsp-replaceTitle-indo");
        l.table = document.getElementById("flygoalsp-EmbedTable-indo"), 
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper">' +
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="flygoalsp-replaceBadge-indo" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LEAGUE STANDINGS TABLE</div>' + 
                '<a class="flygoalsp-medium-title" id=\'flygoalsp-replaceTitle-indo\'></a>' +
            '</div>' +
        '</div>' +
        '<div class="flygoalsp-embed-body">' + 
            '<table class="flygoalsp-embed-table" id="flygoalsp-EmbedTable-indo">' + 
                '<thead>' + 
                    ...
                    '</tr>' +
                '</thead>' +
                '<tbody id=\'flygoalsp-InsertRowsHere-indo\'></tbody>' +
            '</table>' +
            '</div>' +
        '</div>' +
    '</div>'
