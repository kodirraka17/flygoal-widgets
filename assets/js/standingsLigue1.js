! function(e) {
    ...
    function r(e) {
        ...
        var u = document.getElementById("flygoalsp-InsertRowsHere-ligue1"),
            f = document.getElementById("flygoalsp-replaceBadge-ligue1"),
            p = document.getElementById("flygoalsp-replaceTitle-ligue1");
        l.table = document.getElementById("flygoalsp-EmbedTable-ligue1"), 
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper">' +
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="flygoalsp-replaceBadge-ligue1" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LEAGUE STANDINGS TABLE</div>' + 
                '<a class="flygoalsp-medium-title" id=\'flygoalsp-replaceTitle-ligue1\'></a>' +
            '</div>' +
        '</div>' +
        '<div class="flygoalsp-embed-body">' + 
            '<table class="flygoalsp-embed-table" id="flygoalsp-EmbedTable-ligue1">' + 
                '<thead>' + 
                    ...
                    '</tr>' +
                '</thead>' +
                '<tbody id=\'flygoalsp-InsertRowsHere-ligue1\'></tbody>' +
            '</table>' +
            '</div>' +
        '</div>' +
    '</div>'
