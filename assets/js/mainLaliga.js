! function(e) {
    ...
    ! function(e) {
        var t = {
            ...
            n = e[e.flygoalsp_StandingsEmbedLaliga],
            o = n.q;
        if (o)
    ...
    function r(e) {
        ...
        var r = "https://widget.flygoal.com/e/Standings?id=1134",
            s = document.createElement("div");
        s.innerHTML = c.a, document.getElementById('flygoalsp-standings-laliga').insertAdjacentElement("afterbegin", s);
        var u = document.getElementById("fgInsertRowsHere-laliga"),
            f = document.getElementById("replaceBadge-laliga"),
            p = document.getElementById("replaceTitle-laliga");
        l.table = document.getElementById("fgEmbedTable-laliga"), 
    ...
    e.exports = '<div class="flygoalsp-embed-wrapper">' +
        '<div class="flygoalsp-embed-header">' + 
            '<div class="flygoalsp-header-badge">' + 
                '<img id="replaceBadge-laliga" alt="">' + 
            '</div>' + 
            '<div class="flygoalsp-header-title">' + 
                '<div class="flygoalsp-strong-title">LEAGUE STANDINGS TABLE</div>' + 
                '<a class="flygoalsp-medium-title" id=\'replaceTitle-laliga\'></a>' +
            '</div>' +
        '</div>' +
        '<div class="flygoalsp-embed-body">' + 
            '<table class="flygoalsp-embed-table" id="fgEmbedTable-laliga">' + 
                '<thead>' + 
                    ...
                    '</tr>' +
                '</thead>' +
                '<tbody id=\'fgInsertRowsHere-laliga\'></tbody>' +
            '</table>' +
            '</div>' +
        '</div>' +
    '</div>'
