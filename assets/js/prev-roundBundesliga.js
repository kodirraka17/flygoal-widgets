! function(e) {
    ...
    ! function(e) {
        var t = {
            ...
            n = e[e.flygoalpr_PreviousRoundBundesliga],
            i = n.q;
        if (i)
    ...
    function r(e) {
        ...
        o.innerHTML = i.a, document.getElementById("flygoalpr-previous-round-bundesliga").insertAdjacentElement("afterbegin", o);
        var u = document.getElementById("flygoalpr-previous-round-here-bundesliga"),
            c = document.getElementById("flygoalpr-replaceBadge-bundesliga"),
            s = document.getElementById("flygoalpr-replaceTitle-bundesliga");
        fetch(r, {
            method: "GET",
            mode: "cors"
        }).then(function(e) {
    ...
    e.exports = '<div class="flygoalpr-embed-wrapper fixtures">' + 
        '<div class="flygoalpr-embed-header">' + 
            '<div class="flygoalpr-header-badge">' + 
                '<img id="flygoalpr-replaceBadge-bundesliga" alt="">' + 
            '</div>' + 
            '<div class="flygoalpr-header-title">' + 
                '<div class="flygoalpr-strong-title">LAST RESULT</div>' + 
                '<div class="flygoalpr-medium-title" id=\'flygoalpr-replaceTitle-bundesliga\'></div>' + 
            '</div>' + 
            '</div>' +
            '<div class="flygoalpr-embed-body">' + 
                '<ul class="flygoalpr-next-round-list" id="flygoalpr-previous-round-here-bundesliga"></ul>' + 
            '</div>' + 
        '</div>' + 
    '</div>'
}, function(e, t, n) {
